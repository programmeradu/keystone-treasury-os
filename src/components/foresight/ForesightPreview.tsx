    ...
    <script>
        (function() {
            try {
                ...
                rootEl.innerHTML = '<div style="color:#ef4444;padding:20px;font-family:monospace;font-size:13px;line-height:1.6">' +
                    '<strong style="color:#f87171">Foresight Error</strong><br/>' +
                    '<span id="foresight-error-msg" style="color:#fca5a5"></span></div>';
                var msgEl = document.getElementById('foresight-error-msg');
                if (msgEl) {
