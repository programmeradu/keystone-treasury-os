    ...
    <script>
        ...
        (function() {
            try {
                ...
                rootEl.innerHTML = '<div style="color:#ef4444;padding:20px;font-family:monospace;font-size:13px;line-height:1.6"><strong style="color:#f87171">Runtime Error</strong><br/><span id="runtime-error-msg" style="color:#fca5a5"></span></div>';
                document.getElementById('runtime-error-msg').textContent = err.message || String(err);
