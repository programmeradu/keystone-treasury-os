...
<body>
  ...
  <script>
    try {
      ...
      rootEl.innerHTML = '<div style="color:#ef4444;padding:20px;font-family:monospace"><strong>Error:</strong> <span class="error-msg"></span></div>';
      rootEl.querySelector('.error-msg').textContent = e.message;
    }
  </script>
</body>
</html>`;
