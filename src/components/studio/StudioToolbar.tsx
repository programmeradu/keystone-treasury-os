...
<body>
  ...
  <script>
    try {
      ...
      rootEl.innerHTML = '<div style="color:#ef4444;padding:20px;font-family:monospace"><strong>Error:</strong> <span id="ks-err-msg"></span></div>';
      document.getElementById('ks-err-msg').textContent = e.message || e;
    }
  </script>
</body>
</html>`;
