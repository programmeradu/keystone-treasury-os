...
<body>
  ...
  <script>
    try {
      ...
      rootEl.innerHTML = '<div style="color:#ef4444;padding:20px;font-family:monospace"><strong>Error:</strong> <span id="studio-err"></span></div>';
      document.getElementById('studio-err').textContent = e.message || String(e);
    }
  </script>
</body>
</html>`;
