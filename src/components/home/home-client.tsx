...
export const HomeClient = () => {
  return (
    <div className="relative min-h-dvh w-full bg-[var(--dreyv-void)] text-white scroll-smooth motion-reduce:scroll-auto">
      {/* Shared ambient gradient mesh - covers header + hero seamlessly */}
      <div className="fixed inset-0 pointer-events-none z-0" aria-hidden="true">
        <div className="absolute top-[-10%] left-[-10%] h-[700px] w-[700px] rounded-full bg-dreyv-green/[0.07] blur-[150px] animate-drift-slow" />
      ...
      <a
        href="#content"
        className="sr-only focus:not-sr-only fixed left-3 top-3 z-[100] rounded-md bg-[var(--dreyv-void)] px-3 py-1 text-sm shadow border border-white/10 text-white"
      >
        Skip to content
      </a>
