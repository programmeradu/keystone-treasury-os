...
export function VaultAssetsCompact({ tokens }: { tokens: TokenAccount[] }) {
    ...
    // Wrap token sorting and slicing in useMemo to prevent O(N log N) recomputation on every render.
    // Expected impact: Reduces main thread blocking when dashboard state changes.
