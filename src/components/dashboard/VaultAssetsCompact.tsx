                                        ...
                                        <div className="w-8 h-8 rounded-full overflow-hidden border border-border bg-muted shadow-sm">
                                            <img
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    parent.innerHTML = '<div class="w-full h-full flex items-center justify-center bg-primary text-[10px] text-primary-foreground font-bold fallback-symbol"></div>';
                                                    parent.querySelector('.fallback-symbol')!.textContent = token.symbol ? token.symbol[0] : "T";
                                                }}
                                            />
                                        </div>
                                    ) : (
