                                        ...
                                        <div className="w-8 h-8 rounded-full overflow-hidden border border-border bg-muted shadow-sm">
                                            <img
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    // Use textContent for dynamic user input to prevent XSS
                                                    parent.innerHTML = '<div class="fallback-placeholder w-full h-full flex items-center justify-center bg-primary text-[10px] text-primary-foreground font-bold"></div>';
