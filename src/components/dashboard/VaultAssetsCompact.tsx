...
export function VaultAssetsCompact({ tokens }: { tokens: TokenAccount[] }) {
    ...
    // Performance optimization: Memoize the sorting of tokens (O(n log n)) to prevent expensive recalculation on every render.
    // Impact: Reduces CPU time when re-rendering VaultAssetsCompact during frequent dashboard state updates.
