                                            ...
                                            <img
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    if (target.parentElement) {
                                                        ...
                                                        fallbackDiv.className = "w-full h-full flex items-center justify-center bg-primary text-[10px] text-primary-foreground font-bold";
                                                        fallbackDiv.textContent = token.symbol ? token.symbol[0] : "T";
